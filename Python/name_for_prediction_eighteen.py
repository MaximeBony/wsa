...
with open('eighteen_final_min.csv', 'r', newline='') as csvfile:
    csvreader = csv.reader(csvfile, delimiter=',', quotechar='"')
    for l in csvreader:
        id_score_dict[l[0]] = l[1]

# Getting players ids and names
with open('seventeen_players_means.csv', 'r', newline='') as csvfile:
    csvreader = csv.reader(csvfile, delimiter=',', quotechar='"')
    for l in csvreader:
...
final_file = open("eighteen_final_min_predicted_ranking.csv", "w", newline="")
